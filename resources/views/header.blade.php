            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <ul class="navbar-nav mb-2 mb-lg-0">
                    <div class="d-flex align-items-center mt-1 tf">
                        ...
                        <a href="#" class="hvr-bounce-in hvr-underline-from-left text-decoration-none mdel-n borh text-light px-2 py-2"><span
                                class="tcs  m-0 ts fsh-t  text-light px-2 py-2">КЛЮЧИ</span></a>
                        <a href="#"
                            class="hvr-bounce-in text-decoration-none hvr-underline-from-left borh text-light px-2 py-2"><span
                                class="tcs  m-0 ts fsh-t  ">ГИФТЫ</span></a>
                        <a href="#"
                            class="hvr-bounce-in text-decoration-none hvr-underline-from-left mdel-p borh text-light px-2 py-2"><span
                                class="tcs  m-0 ts fsh-t ">АККАУНТЫ</span></a>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-center ip">
                        ...
                        <div class="position-relative">
                            <a class="text-black svgs sb position-relative text-decoration-none dropdown-toggle btnsrc"
                                type="button">
                        ...
                        <a href="{{ route('page_user_auth') }}"
                            class="ms-3 sb text-decoration-none text-black dm ddm">
                            <svg class="text-black svgs" xmlns="http://www.w3.org/2000/svg" width="25"
                        ...
                        <a href="#" class="ms-3 sb text-decoration-none text-black dm">
                            <svg class="text-black svgs" xmlns="http://www.w3.org/2000/svg" width="25"
                                height="25" fill="currentColor" class="bi bi-suit-heart-fill" viewBox="0 0 16 16">
                                <path
                        ...
                        <a href="#" class="ms-3 sb text-decoration-none text-black btnt">
                            <svg class="text-black svgs" xmlns="http://www.w3.org/2000/svg" width="25"
                                height="25" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
                                <path
