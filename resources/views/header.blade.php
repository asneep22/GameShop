            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-6">
                    ...
                    <div class="d-flex ip pt-2">
                        ...
                        <div class="dropdown">
                            <a class="sb text-decoration-none text-white dropdown-toggle" type="button"
                            ...
                            <form action="search"
                                class="dropdown-menu dropdown-menu-start form-b p-0 mt-2 m-auto fws position-absolute"
                        ...
                        <a href="{{ route('page_user_auth') }}"
                            class="ms-3 sb text-decoration-none text-white dm ddm">
