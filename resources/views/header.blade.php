...
<header class=" container-fluid hbg theme dfh">
    ...
    <nav class="navbar navbar-expand-lg navbar-light theme hbg">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <div class="d-flex align-items-center mt-1 tf">
                        <a href="#" class="text-decoration-none ui-box top-stay mdel-g"><span class="tcs text-black m-0 ts fsh-t ui-border-element">ГЛАВНАЯ</span></a>
                        <a href="#" class="text-decoration-none ui-box top-stay mdel-n"><span class="tcs text-black m-0 ts fsh-t ui-border-element">НОВИНКИ</span></a>
                        <a href="#" class="text-decoration-none ui-box top-stay"><span class="tcs text-black m-0 ts fsh-t ui-border-element ">СКИДКИ</span></a>
                        <a href="#" class="text-decoration-none ui-box top-stay mdel-p"><span class="tcs text-black m-0 ts fsh-t ui-border-element">ПОПУЛЯРНЫЕ</span></a>
                    </div>
                    <div class="d-flex ip pt-2">
                        <!-- Выпадающие меню поиска -->

                        <div class="dropdown">
                            <a class="text-black svgs sb text-decoration-none text-black dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <a href="{{ route('page_user_auth') }}" class="ms-3 sb text-decoration-none text-black dm ddm">
                            <svg class="text-black svgs" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-bounding-box" viewBox="0 0 16 16">
                        ...
                        <a href="#" class="ms-3 sb text-decoration-none text-black dm">
                            <svg class="text-black svgs" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-suit-heart-fill" viewBox="0 0 16 16">
                        ...
                        <a href="#" class="ms-3 sb text-decoration-none text-black dm">
                            <svg class="text-black svgs" xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-fill" viewBox="0 0 16 16">
                                <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z" />
                            </svg>
                        </a>
                        <!-- Тема сайта -->

                        <a href="#" class="ms-3 sb text-decoration-none text-black dm btnt">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark hbg-d">
        <div class="container-fluid">
            <div class="d-flex flex-column">
                <a href="{{route('page_welcome')}}" class="text-decoration-none text-white mb-0 p-0">
                    <h1 href="#" class="fs-1 text-decoration-none text-white ts m-0">ГеймШоп
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 fs-6">
                    <div class="d-flex align-items-center mt-1 tf">
                        <a href="{{route('page_welcome')}}" class="text-decoration-none ui-box top-stay mdel-g"><span class="text-white m-0 ts fsh-t ui-border-element">ГЛАВНАЯ</span></a>
                        <a href="{{route('page_all_products')}}" class="text-decoration-none ui-box top-stay mdel-n"><span class="text-white m-0 ts fsh-t ui-border-element">ВСЕ ИГРЫ</span></a>
                    </div>
                    <div class="d-flex ip pt-2">
                        <!-- Выпадающие меню поиска -->
