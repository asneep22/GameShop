            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <ul class="navbar-nav mt-2 mb-lg-0">
                    ...
                    <div class="d-flex align-items-center justify-content-center ip">
                        ...
                        <a href="{{ route('page_user_auth') }}" class="ms-3 sb text-decoration-none text-white dm ddm hvr-bounce-in">
                        ...
                        <a href="#" class="ms-3 sb text-decoration-none text-white dm hvr-bounce-in">
                        ...
                        <a href="{{route('page_shopping_cart')}}" class="ms-3 sb text-decoration-none text-white dm hvr-bounce-in">
                        ...
                        <a href="#" class="ms-3 sb text-decoration-none text-white btnt hvr-bounce-in">
                        ...
                        <div class="position-relative">
                            <a class="text-white svgs sb position-relative text-decoration-none btnsrc hvr-bounce-in" type="button">
