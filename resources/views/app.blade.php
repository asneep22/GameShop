...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self'; img-src 'self'; frame-src 'self'; worker-src self; style-src 'self' https://fonts.googleapis.com 'unsafe-inline'; script-src 'self' ; font-src 'self' https://fonts.gstatic.com">
    <!-- Шрифты -->
