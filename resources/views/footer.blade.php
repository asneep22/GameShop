        ...
        <div class="container-fluid jcb">
            <ul class="me-auto mb-2 mb-lg-0 d-flex ft-f">
                <div class="d-flex align-items-center mt-1 tf-f">
                    ...
                    <a href="#" class="text-decoration-none text-muted m-0 ts mb-f px-4 nt">КЛЮЧИ</a>
                    <a href="#" class="text-decoration-none text-muted m-0 ts mb-f nt">ГИФТЫ</a>
                    <a href="#" class="text-decoration-none text-muted m-0 ts mb-f px-4 nt">АККАУНТЫ</a>
                </div>
                <div class="d-flex justify-content-center align-items-center ip-f">
                    ...
                    <a href="{{route('page_user_auth')}}" class="svgs text-secondary ms-3 sb text-decoration-none text-muted dm ddm">
                    ...
                    <a class="svgs text-secondary ms-3 sb text-decoration-none text-muted dm btnt">
        ...
        <div class="container-fluid jcb">
            <ul class="me-auto mb-2 mb-lg-0 d-flex ft-f p-0">
                ...
                <div class="d-flex justify-content-center align-items-center ip-f mt-3">
                    ...
                    <a href="#" class="ms-3 sb text-decoration-none text-muted dm btnt">
