    ...
    <div class="container py-4 px-1">
        <div class="d-xl-flex justify-content-center">
            ...
            <div class="d-lg-flex flex-column me-3 text-center" id="our_pluses">
                <a href="" class="d-flex our-pluses-block-md  mb-3 text-decoration-none hvr-bounce-to-top" data-aos="fade-right" data-aos-anchor-placement="center-bottom">
                ...
                <a href class="our-pluses-block-md d-flex text-center text-decoration-none hvr-bounce-to-bottom mb-3" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                    <div class="px-3 text-light d-flex our-pluses-block our-pluses-border-orange">
                        <div class="m-auto" style="z-index: 2">
            ...
            <div class="d-lg-flex flex-column me-3 text-center" id="our_pluses">
                <div class="d-xl-flex">
                    <a href="" class="text-decoration-none d-flex our-pluses-block-md mb-3 me-xl-3 hvr-bounce-to-left" data-aos="zoom-out" data-aos-anchor-placement="center-bottom">
                    ...
                    <a href="" class="text-decoration-none hvr-bounce-to-right d-flex our-pluses-block-md mb-3" data-aos="fade-left" data-aos-anchor-placement="center-bottom">
                        <div class="px-3 text-light our-pluses-block our-pluses-border-orange our-pluses-block-long-md d-flex">
                            <div class="m-auto" style="z-index: 2">
                                <h4 class="mt-3">Низкие цены</h4>
                ...
                <a href="#" class="text-decoration-none d-flex text-center hvr-bounce-to-left" data-aos="fade-up" data-aos-anchor-placement="center-bottom">
                    <div class="px-3 text-light d-flex flex-column our-pluses-block our-pluses-border-orange our-pluses-block-long our-pluses-block-md">
                        <div class="m-auto" style="z-index: 2">
...
<div class="container w-100 py-0 mx-auto my-0">
    <div class="rounded">
        ...
        <div class="d-flex flex-column">
                ...
                <div class="carousel-inner pb-3">
                    <div class="carousel-item active">
                        <div class="d-lg-flex justify-content-lg-between mx-auto">
                            ...
                            <a href="{{ route('page_product', $products_red->first()->id) }}" data-aos="fade-right" class="big-card rounded p-0 d-flex align-items-end text-decoration-none text-light" style="background: url({{ URL::asset('/storage/' . $products_red->first()->file_path) }})">
                    ...
                    <div class="carousel-item">
                        <div class="d-lg-flex justify-content-lg-between mx-auto">
                            <!-- Блок большой карточки -->
                            <a href="{{ route('page_product', $products_red->last()->id) }}" data-aos="fade-right" class="big-card rounded p-0 d-flex align-items-end" style="background: url({{ URL::asset('/storage/' . $products_red->last()->file_path) }})">
                                <div class="big-card-footer rounded d-flex flex-column">
                                    <div class="descr m-auto">
            ...
            <div data-aos="fade-right" class="m-auto">
                <a href="{{ route('page_all_products') }}" class="btn-green mt-1 p-2 px-5 mb-4 m-auto text-decoration-none text-light hvr-grow-shadow">Больше</a>
            </div>
        </div>
        @endif
    </div>
        ...
        <div class="d-flex flex-column">
            ...
            <div class="mt-3 d-flex text-black tcs">
                ...
                <div class="d-lg-flex text-center my-auto me-0 mx-auto text-black tcs" data-aos="fade-left">
                    <a href="#" class="text-decoration-none text-black tcs">Новинки</a>
                    <a href="#" class="px-4 text-decoration-none text-black tcs ">Популярное</a>
                    <a href="#" class="text-decoration-none text-black tcs">Часто покупаемые</a>
                </div>
                <div class="d-lg-flex text-center">
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-between">
                ...
                <div class="mb-4 d-flex flex-column game-card pb-0 rounded hvr-underline-from-right underline-blue" data-aos="fade-up">
                    ...
                    <div class=" mb-0 my-auto p-0">
                        ...
                        <div class="btn-group mb-0 d-flex">
                            <a href="{{ route('add_product_to_cart', $item->id) }}" class="btn-blue hvr-float text-decoration-none text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cart4" viewBox="0 0 16 16">
                                    <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z" />
                                </svg></a>
                            <a href="{{ route('page_product', $item->id) }}" class="btn-blue hvr-float text-decoration-none text-light"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-up-right" viewBox="0 0 16 16">
